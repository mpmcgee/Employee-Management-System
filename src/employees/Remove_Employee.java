...
class Remove_Employee implements ActionListener {
    ...
    Remove_Employee() {
        ...
        Font f3 = new Font("times", Font.BOLD, 20);
        l2.setFont(f3);
        l5.add(l2);
        ...
        Font F6 = new Font("times", Font.BOLD, 20);
        l6.setFont(F6);
        l5.add(l6);
        ...
        Font f4 = new Font("times", Font.BOLD, 20);
        l3.setFont(f4);
        l5.add(l3);
        ...
        Font F7 = new Font("times", Font.BOLD, 20);
        l7.setFont(F7);
        l5.add(l7);
        ...
        Font F5 = new Font("times", Font.BOLD, 20);
        l4.setFont(F5);
        l5.add(l4);
        ...
        Font f8 = new Font("times", Font.BOLD, 20);
        l8.setFont(f8);
        l5.add(l8);
    ...
    public void actionPerformed(ActionEvent ae) {
        ...
        if (ae.getSource() == b) {
            try {
                conn con = new conn();
                String str = "select name, phone from employee where emp_id ='" + t.getText() + "' ";
