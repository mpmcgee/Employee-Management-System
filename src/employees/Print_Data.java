...
class Print_Data implements ActionListener{
    ...
    String emp_id,fname,lname,dhired,dob,address,city,state,zip,phone;
    JButton b1,b2;
    ImageIcon icon;
    ...
    Print_Data(String e_id){
        ...
        f.add(id8);
        id8.setFont(new Font("times",Font.BOLD,25));
        id9.add(id8);
        f.add(id9);

        id = new JLabel("Employee Id:");
        id.setBounds(50,70,120,30);
        id.setFont(new Font("times",Font.BOLD,20));
        id9.add(id);
        ...
        id1.setFont(new Font("times",Font.BOLD,20));
        id9.add(id1);

        aid1 = new JLabel(fname);
        aid1.setBounds(200,120,300,30);
        aid1.setFont(new Font("times",Font.BOLD,20));
        id9.add(aid1);


        id2 = new JLabel("Last Name:");
        id2.setBounds(50,170,200,30);
        id2.setFont(new Font("times",Font.BOLD,20));
        id9.add(id2);

        aid2 = new JLabel(lname);
        aid2.setBounds(200,170,300,30);
        aid2.setFont(new Font("times",Font.BOLD,20));
        id9.add(aid2);

        id3= new JLabel("Date Hired:");
        id3.setBounds(50,220,100,30);
        id3.setFont(new Font("times",Font.BOLD,20));
        id9.add(id3);

        aid3= new JLabel(dhired);
        aid3.setBounds(200,220,300,30);
        aid3.setFont(new Font("times",Font.BOLD,20));
        id9.add(aid3);
        ...
        aid4.setFont(new Font("times",Font.BOLD,20));
        id9.add(aid4);
        ...
        aid5.setFont(new Font("times",Font.BOLD,20));
        id9.add(aid5);
        ...
        aid6= new JLabel(city);
        aid6.setBounds(200,370,300,30);
        aid6.setFont(new Font("times",Font.BOLD,20));
        id9.add(aid6);
        ...
        aid7= new JLabel(state);
        aid7.setBounds(200,420,300,30);
        aid7.setFont(new Font("times",Font.BOLD,20));
        id9.add(aid7);
